...
import { ProductsContext, useProducts } from "../ProductsContext";
  ...
  return (
    <div key={Product.id} className="bg-white">
      <div className=" ">
        ...
        {/* Image gallery */}
        <div className=" lg:hidden max-w-[1400px] h-[500px] w-full mx-auto mt-6  px-4 relative group">
          <div
            style={{
              backgroundImage: `url(${product.images[currentIndex].src})`,
            }}
            ...
            <div className="mt-10">
              ...
              <div className="mt-4">
                <ul role="list" className="list-disc space-y-2 pl-4 text-sm">
                  {Product.discription.highlight.map((highlight, index) => (
